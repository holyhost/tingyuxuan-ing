...
import tingyuxuan.hosition.zxyoyo.com.tingyuxuan.adapter.FavorBookAdapter;
...
public class FavorityFragment extends BaseFragment {
    ...
    FavorBookAdapter adapter;

    public static FavorityFragment newInstance() {
        return new FavorityFragment();
    }
    @Override
    ...
    private void initData() {
        showLoading();
        List<FavorBean> myBorrowBooks = DbUtil.getMyFavorBooks(getContext());
        adapter = new FavorBookAdapter(getContext(),myBorrowBooks);
