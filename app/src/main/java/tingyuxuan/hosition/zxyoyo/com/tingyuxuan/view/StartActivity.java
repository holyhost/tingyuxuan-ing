...
//                toggle();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Boolean first = getSharedPreferences("user", MODE_PRIVATE).getBoolean("first", true);
                if(first){
                    //只初始化一次数据
                    DbHelper helper = new DbHelper(StartActivity.this,"tingyuxuan.db",null,1);
                    helper.addUser("admin","123321","2024212728@qq.com",9);
